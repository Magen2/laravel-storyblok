...
class StoryblokServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $datasourceEntriesApi = new DatasourceEntriesApi($client);
        $this->app->instance(DatasourceEntriesApi::class, $datasourceEntriesApi);

        $this->app->singleton(ContentApi::class, fn () => new ContentApi($storiesApi, $datasourceEntriesApi));

        $this->app->singleton('storyblok', fn ($app) => new Storyblok(
            $app->make(StoriesApi::class),
            $app->make(ContentApi::class),
            $app->make(DatasourceEntriesApi::class),
        ));
